...
//   static std::unordered_map<batteries::grid_location<int>, batteries::grid_location<int>> AStarSearch(const World &world, const batteries::grid_location<int> &start, int step_limit);
//   static std::unordered_map<batteries::grid_location<int>, batteries::grid_location<int>> BreadthFirstSearch(const World &world, const batteries::grid_location<int> &start, int step_limit);
//   static std::unordered_map<batteries::grid_location<int>, batteries::grid_location<int>> DijkstraSearch(const World &world, const batteries::grid_location<int> &start, int step_limit);
//   static std::unordered_map<batteries::grid_location<int>, batteries::grid_location<int>> GreedySearch(const World &world, const batteries::grid_location<int> &start, int step_limit);
