...
std::unordered_map<batteries::grid_location<int>, batteries::grid_location<int>> Pathfinding::DijkstraSearch(const World &world, const batteries::grid_location<int> &start, int step_limit)
{
